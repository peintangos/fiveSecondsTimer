//
//  JustGetMiddlePlayWithOthers3ViewController.swift
//  tenSecondsTimer
//
...
class JustGetMiddlePlayWithOthers3ViewController: UIViewController,UITextFieldDelegate {
...
//        self.startStop.addTarget(self, action: #selector(tapStart), for: UIControl.Event.touchUpInside)
        ...
        self.view.addSubview(payer1.makeTitle(name: "\(name ?? "player3")さんの挑戦です"))
        makeMessagefirst()
    ...
    @objc func resetData(){
        if (isFirst2!){
            ...
            if isUserNameSaved(){
                ...
                self.saveJustGetMiddleReultWithOthers(name: "player3", stroke: Double(CGFloat(stroke!)))
                ...
                default:
                viewController = storyBoard.instantiateViewController(identifier: "JustGetMiddlePlayWithOthers4ViewController")
                }
                ...
                self.saveJustGetMiddleReultWithOthers(name: name!, stroke: Double(CGFloat(stroke!)))
                    ...
                    default:
                        ...
                        alert.addAction(UIAlertAction(title: "入力完了", style: .default, handler: { [self] (action) in
                            let storyBoard = UIStoryboard(name: "Main", bundle: nil)
                    let viewController = storyBoard.instantiateViewController(identifier: "JustGetMiddlePlayWithOthers4ViewController") as! JustGetMiddlePlayWithOthers4ViewController
