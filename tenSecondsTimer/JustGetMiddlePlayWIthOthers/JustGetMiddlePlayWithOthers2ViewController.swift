//
//  JustGetMiddlePlayWithOthersForMasterPlayerViewController.swift
//  tenSecondsTimer
//
...
class JustGetMiddlePlayWithOthers2ViewController:UIViewController,UITextFieldDelegate {
...
//        self.startStop.addTarget(self, action: #selector(tapStart), for: UIControl.Event.touchUpInside)
        ...
        self.view.addSubview(payer1.makeTitle(name: "\(name ?? "player2")さんの挑戦です"))
        makeMessage()
        makeMessagefirst()
