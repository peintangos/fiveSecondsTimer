...
class Player8ViewController: UIViewController,UITextFieldDelegate {
...
//    var playerNumber:Int?
    ...
    func goNext(playerNumber:Int){
        if isSaved!{
            ...
            let nav = UIAlertController(title: "九人目の名前を入力してね", message:nil, preferredStyle: .alert)
