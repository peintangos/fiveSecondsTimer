...
class Player5ViewController: UIViewController,UITextFieldDelegate {
    var name:String?
//    var playerNumber:Int?
    ...
    func goNext(playerNumber:Int){
        if isSaved!{
            ...
            let nav = UIAlertController(title: "六人目の名前を入力してね", message:nil, preferredStyle: .alert)
